...
define MINIKUBE_GO_BUILD_CMD
	$(MINIKUBE_ENV_$(2)) go build -tags container_image_ostree_stub --installsuffix cgo -ldflags="$(MINIKUBE_LDFLAGS) $(K8S_VERSION_LDFLAGS)" -a -o $(1) k8s.io/minikube/cmd/minikube
endef
